const argsFilter = require('../../src/filters/args');
...
const table = [
	...
	[true, 'some text', {text: 'some text'}],
	[true, 'some text', {type: 'string', text: 'some text'}],
	[true, 'i:post', {type: 'object', text: 'WP_Post{72}'}],
	[false, 'object', {type: 'object', text: 'WP_Post{72}'}],
	[true, 'object', {type: 'object'}],
	[false, 'c', {a: 'b'}],
];
...
test.each(table)(
	...
	(expected, headerValue, rowValue) => {
		expect(argsFilter(headerValue, rowValue)).toStrictEqual(expected);
	},
);